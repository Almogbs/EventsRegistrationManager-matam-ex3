...
int main() {
    ...
    OpenEvent oe(DateWrap(1,2,3), "mamam");
    ...
    ClosedEvent ce1(DateWrap(4,6,1222), "I am Date!");
    ce1.addInvitee(55);
    ce1.addInvitee(12);
    ce1.addInvitee(33);
    ce1.addInvitee(22);
    ...
    CustomEvent<StudentFilter> cc1(DateWrap(22,2,22222), "I am Almog!", StudentFilter());
